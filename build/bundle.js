...
},{"./Game.jsx":151,"react":148}],2:[function(require,module,exports){
...
var Game = React.createClass({displayName: 'Game',
  ...
  render: function(){
    var rows = [];
    for (var i = 0; i < colSize; i++){
      rows.push (React.createElement(Row, {index: i, content: this.state[i], handleClick: this.handleClick}));
    }
...
},{"./Row.jsx":152,"react":148,"underscore":149}],152:[function(require,module,exports){
...
/*  getInitialState: function(){
  ...
  render: function(){
    var boxes = [];
    for (var i = 0; i < this.props.content.length; i++){
      boxes.push (React.createElement(Box, {index: i, content: this.props.content[i], handleClick: this.handleClick}));
    }
